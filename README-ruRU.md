...
* <a name="config-initializers"></a>
  Держите код, выполняющийся при инициализации приложения в `config/initializers`.
...
Настройте среду окружения для разработки, тестов и деплоя (в соответствующих файлах, лежащих в `config/environments/`)
...
* <a name="model-classes"></a>
	Не бойтесь создавать классы моделей, которые не наследуют ActiveRecord.
